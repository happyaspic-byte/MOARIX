...
const groups: ReadonlyArray<{
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/assets", label: "고객 자산", icon: Store, permission: "assets:read" },
      { href: "/service", label: "서비스 케이스", icon: Wrench, permission: "service:read" },
      { href: "/reports", label: "표준 보고서", icon: ChartNoAxesCombined, permission: "reports:read" },
    ],
  },
  {
    label: "관리",
